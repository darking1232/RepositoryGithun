...
const struct {
	...
	{"buildmanager", "Saves Stats Builds for easy switching."},  
	{"remove", "Removes Carts/falcon/Pecopeco"},  
	{"mapmove", "Moves player to specific map and coordinates"},  
	{"where", "Displays your current map and position"},  
	{"jumpto", "Teleports you to another player's location"},  
	{"jump", "Randomly jumps to a walkable cell on the current map"},  
	{"who", "Displays a list of online players"},  
	{"whogm", "Displays a list of online GMs"},  
	{"save", "Sets your current location as your save point"},  
	{"load", "Teleports you to your save point"},  
	{"commands", "Lists all available commands"},
	{"speed", "Changes your character's movement speed"},
	{"storage", "Opens your Kafra storage"},
	{"guildstorage", "Opens your guild storage"},
	{"option", "Sets various visual or status options (e.g. disguise, mount)"},
	{"hide", "Toggles GM hide mode to become invisible"},
	{"resetcooltime", "Resets item and skill cooldowns"},
	{"jobchange", "Changes your current job class"},
	{"kill", "Instantly kills the targeted player or monster"},
	{"alive", "Revives yourself with full HP/SP"},
	{"kami", "Displays a global message with your name"},
	{"kamib", "Displays a global message in blue color"},
	{"kamic", "Displays a global message in cyan color"},
	{"lkami", "Displays a local message at your location"},
	{"heal", "Fully restores HP and SP"},
	{"healap", "Fully restores HP, SP, and AP (3rd job resources)"},
	{"item", "Gives specified item(s) to yourself"},
	{"item2", "Gives item(s) with custom refinement/card/socket options"},
	{"itembound", "Gives account-bound items"},
	{"itembound2", "Gives account-bound items with custom options"},
	{"itemreset", "Removes all items from inventory, cart, and equipment"},
	{"clearstorage", "Removes all items from your storage"},
	{"cleargstorage", "Removes all items from your guild storage"},
	{"clearcart", "Removes all items from your cart"},
	{"baselevelup", "Increases your base level by one"},
	{"joblevelup", "Increases your job level by one"},
	{"help", "Displays help message or usage for a command"},
	{"pvpoff", "Disables PvP on the current map"},
	{"pvpon", "Enables PvP on the current map"},
	{"gvgoff", "Disables GvG mode on the current map"},
	{"gvgon", "Enables GvG mode on the current map"},
	{"model", "Changes your character's sprite appearance"},
	{"go", "Teleports you to a predefined town or area"},
	{"monster", "Summons a monster at your location"},
	{"monstersmall", "Summons a monster in small size"},
	{"monsterbig", "Summons a monster in big size"},
	{"killmonster", "Kills all monsters on the current map"},
	{"killmonster2", "Kills all monsters except event-spawned or protected"},
	{"refine", "Refines equipped item to specified level"},
	{"grade", "Grades a refine level into enchant tier"},
	{"produce", "Crafts a weapon or item as a smith/alchemist"},
	{"memo", "Saves the current map as a warp memo point"},
	{"gat", "Displays detailed map cell info (GAT debug tool)"},
	{"displaystatus", "Displays all status changes currently active"},
	{"statuspoint", "Sets the amount of unused status points"},
	{"traitpoint", "Sets the amount of unused trait points"},
	{"skillpoint", "Sets the amount of unused skill points"},
	{"zeny", "Gives or removes zeny (currency) from player"},
	{"str", "Sets your STR stat"},
	{"agi", "Sets your AGI stat"},
	{"vit", "Sets your VIT stat"},
	{"int", "Sets your INT stat"},
	{"dex", "Sets your DEX stat"},
	{"luk", "Sets your LUK stat"},
	{"pow", "Sets your POW trait stat"},
	{"sta", "Sets your STA trait stat"},
	{"wis", "Sets your WIS trait stat"},
	{"spl", "Sets your SPL trait stat"},
	{"con", "Sets your CON trait stat"},
	{"crt", "Sets your CRT trait stat"},
	{"guildlevelup", "Increases your guild's level by one"},
	{"makeegg", "Creates a pet egg for a specific pet"},
	{"hatch", "Hatches a pet egg"},
	{"petfriendly", "Maximizes your pet's intimacy"},
	{"pethungry", "Sets your pet's hunger to 100%"},
	{"petrename", "Allows you to rename your pet"},
	{"recall", "Warps a player to your location"},
	{"night", "Changes game time to night"},
	{"day", "Changes game time to day"},
	{"doom", "Kills all players on the map"},
	{"doommap", "Kills all players on a specified map"},
	{"raise", "Revives all dead players on the map"},
	{"raisemap", "Revives all dead players on a specified map"},
	{"kick", "Kicks a player from the server"},
	{"kickall", "Kicks all players from the server"},
	{"allskill", "Grants all skills available to your class"},
	{"questskill", "Grants all quest-related skills"},
	{"lostskill", "Removes all learned skills"},
	{"spiritball", "Gives spirit spheres (Monk skill resource)"},
	{"soulball", "Gives soul balls (Star Gladiator resource)"},
	{"party", "Creates a party or manages party members"},
	{"guild", "Creates a guild or manages guild features"},
	{"breakguild", "Disbands the target's guild"},
	{"agitstart", "Starts War of Emperium"},
	{"agitend", "Ends War of Emperium"},
	{"mapexit", "Closes the map server (used for restarts)"},
	{"idsearch", "Searches for item, mob, or skill ID"},
	{"broadcast", "Sends a message to all players (public chat)"},
	{"localbroadcast", "Broadcasts message locally (same map)"},
	{"recallall", "Recalls all players to your location"},
	{"reloaditemdb", "Reloads the item database without restart"},
	{"reloadcashdb", "Reloads the cash shop item database"},
	{"reloadmobdb", "Reloads the monster database"},
	{"reloadskilldb", "Reloads the skill database"},
	{"reloadscript", "Reloads all scripts (npc, quests, etc.)"},
	{"reloadatcommand", "Reloads @command configuration"},
	{"reloadbattleconf", "Reloads battle configuration files"},
	{"reloadstatusdb", "Reloads the status configuration database"},
	{"reloadpcdb", "Reloads player class and config data"},
	{"reloadmotd", "Reloads the message of the day"},
	{"reloadquestdb", "Reloads the quest database"},
	{"reloadmsgconf", "Reloads message string configuration"},
	{"reloadinstancedb", "Reloads instance database configuration"},
	{"reloadachievementdb", "Reloads achievement database"},
	{"reloadattendancedb", "Reloads attendance rewards database"},
	{"reloadbarterdb", "Reloads barter/exchange item database"},
	{"reloadlogconf", "Reloads logging configuration"},
	{"partysharelvl", "Sets level difference allowed for EXP sharing"},
	{"mapinfo", "Shows information about the current map"},
	{"dye", "Changes your clothing color"},
	{"hair_style", "Changes your hair style"},
	{"hair_color", "Changes your hair color"},
	{"stat_all", "Maximizes all status points"},
	{"trait_all", "Maximizes all trait stats"},
	{"char_block", "Blocks a character account"},
	{"ban", "Bans a player account"},
	{"char_ban", "Bans a specific character"},
	{"char_unblock", "Unblocks a previously blocked character"},
	{"unban", "Unbans a player account"},
	{"char_unban", "Unbans a specific character"},
	{"mount_peco", "Mounts or dismounts a peco/creature"},
	{"guildspy", "Shows location of all guild members"},
	{"partyspy", "Shows location of all party members"},
	{"clanspy", "Shows location of all clan members"},
	{"repairall", "Fully repairs all broken equipment"},
	{"guildrecall", "Recalls all guild members to your location"},
	{"partyrecall", "Recalls all party members to your location"},
	{"nuke", "Kills the target player instantly with effect"},
	{"shownpc", "Shows an NPC that was previously hidden"},
	{"hidenpc", "Hides the specified NPC"},
	{"loadnpc", "Loads an individual NPC file"},
	{"unloadnpc", "Unloads an individual NPC from the server"},
	{"reloadnpcfile", "Reloads a specific NPC file"},
	{"servertime", "Displays the current server time"},
	{"jail", "Sends a player to jail"},
	{"unjail", "Releases a jailed player"},
	{"jailfor", "Jails a player for a specific duration"},
	{"jailtime", "Checks remaining jail time for a player"},
	{"disguise", "Disguises yourself as a monster"},
	{"undisguise", "Removes disguise"},
	{"email", "Sets or updates your account email"},
	{"effect", "Plays a visual effect on your character"},
	{"follow", "Follows a target player automatically"},
	{"addwarp", "Adds a custom warp point to your memo list"},
	{"skillon", "Enables a disabled skill"},
	{"skilloff", "Disables a specific skill"},
	{"killer", "Flags a player as your personal target"},
	{"npcmove", "Moves an NPC to specific coordinates"},
	{"killable", "Makes your character killable"},
	{"dropall", "Drops all carried items on the ground"},
	{"stockall", "Moves all items to storage"},
	{"storeall", "Stores all items from inventory into storage"},
	{"skillid", "Casts a skill by skill ID and level"},
	{"useskill", "Uses a skill on a target or location"},
	{"displayskill", "Displays info about a skill cast"},
	{"displayskillcast", "Shows skill casting animations"},
	{"displayskillunit", "Shows skill ground units (e.g., traps, AoEs)"},
	{"snow", "Enables snow weather effect on the map"},
	{"sakura", "Enables cherry blossom effect"},
	{"clouds", "Enables cloud weather effect"},
	{"clouds2", "Enables heavy cloud weather effect"},
	{"fog", "Enables fog on the map"},
	{"fireworks", "Triggers firework effects"},
	{"leaves", "Enables falling leaves effect"},
	{"summon", "Summons a clone or monster"},
	{"adjgroup", "Changes a user's group level"},
	{"trade", "Initiates trade with a nearby player"},
	{"send", "Sends a player to a different map"},
	{"setbattleflag", "Sets or changes a battle config flag"},
	{"unmute", "Removes mute status from a player"},
	{"clearweather", "Disables all map weather effects"},
	{"uptime", "Displays how long the server has been running"},
	{"changesex", "Changes your character's sex"},
	{"changecharsex", "Changes sex of a specified character"},
	{"mute", "Mutes a player, disabling chat"},
	{"refresh", "Reloads character data from the server"},
	{"refreshall", "Refreshes data for all players"},
	{"identify", "Identifies an unidentified item"},
	{"identifyall", "Identifies all unidentified items in inventory"},
	{"gmotd", "Displays the GM message of the day"},
	{"misceffect", "Triggers a miscellaneous visual effect"},
	{"mobsearch", "Searches for a specific monster on the map"},
	{"cleanmap", "Removes all dropped items and dead mobs on the map"},
	{"cleanarea", "Cleans up a specific area of items/mobs"},
	{"npctalk", "Forces an NPC to speak a message"},
	{"pettalk", "Forces your pet to say something"},
	{"users", "Displays number of currently online users"},
	{"reset", "Resets status and skill points"},
	{"skilltree", "Resets and rebuilds the skill tree"},
	{"marry", "Marries two characters"},
	{"divorce", "Divorces your current spouse"},
	{"sound", "Plays a sound effect for your client"},
	{"undisguiseall", "Removes disguise from all players on the map"},
	{"disguiseall", "Disguises all players on the map"},
	{"changelook", "Changes visual appearance of a specific look type"},
	{"autoloot", "Toggles automatic looting of dropped items"},
	{"autolootitem", "Adds or removes specific items from autoloot list"},
	{"autoloottype", "Configures what types of items are autolooted"},
	{"mobinfo", "Displays monster info by name or ID"},
	{"exp", "Displays your current base and job experience"},
	{"version", "Displays the server's version info"},
	{"mutearea", "Mutes all players in the surrounding area"},
	{"rates", "Displays server EXP, drop, and other rates"},
	{"iteminfo", "Displays information about an item"},
	{"whodrops", "Shows which monster drops a specific item"},
	{"whereis", "Shows maps where a monster spawns"},
	{"mapflag", "Displays map flags and restrictions"},
	{"me", "Displays an emote-like message with your name"},
	{"monsterignore", "Toggles monster aggression on your character"},
	{"fakename", "Changes your visible character name"},
	{"size", "Changes your character's sprite size"},
	{"showexp", "Toggles display of gained EXP"},
	{"showzeny", "Toggles display of gained zeny"},
	{"showdelay", "Toggles display of skill delay"},
	{"autotrade", "Sets your character into vending mode after logout"},
	{"changegm", "Changes the GM group of a player"},
	{"changeleader", "Transfers party or guild leadership"},
	{"partyoption", "Changes party sharing and item distribution settings"},
	{"invite", "Sends a party or guild invite"},
	{"duel", "Starts a duel with another player"},
	{"leave", "Leaves your current party, guild, or duel"},
	{"accept", "Accepts a party, guild, or duel invite"},
	{"reject", "Rejects a party, guild, or duel invite"},
	{"clone", "Creates a clone of your character"},
	{"slaveclone", "Creates a slave clone of your character"},
	{"evilclone", "Creates an aggressive clone of your character"},
	{"tonpc", "Moves you directly to an NPC"},
	{"commands", "Lists available @ commands for your group"},
	{"noask", "Disables trade, party, and duel requests"},
	{"request", "Toggles acceptance of requests"},
	{"homlevel", "Sets your homunculus' level"},
	{"homevolution", "Evolves your homunculus to its next form"},
	{"hommutate", "Mutates your homunculus to a different type"},
	{"makehomun", "Creates a homunculus"},
	{"homfriendly", "Maximizes your homunculus' intimacy"},
	{"homhungry", "Sets your homunculus' hunger level"},
	{"homtalk", "Makes your homunculus speak"},
	{"hominfo", "Displays homunculus information"},
	{"homstats", "Shows detailed homunculus stats"},
	{"homshuffle", "Randomizes your homunculus' appearance"},
	{"showmobs", "Displays all monsters on the map"},
	{"feelreset", "Resets Star Gladiator's feelings (map affinity)"},
	{"hatereset", "Resets Star Gladiator's hatred targets"},
	{"auction", "Accesses the auction system"},
	{"mail", "Opens your mail interface"},
	{"ksprotection", "Enables anti-KS protection"},
	{"allowks", "Disables anti-KS protection"},
	{"cash", "Grants cash shop points"},
	{"points", "Grants custom points (used in some servers)"},
	{"agitstart2", "Starts War of Emperium SE"},
	{"agitend2", "Ends War of Emperium SE"},
	{"resetskill", "Resets all skill points"},
	{"resetstat", "Resets all status points"},
	{"storagelist", "Displays item list from storage"},
	{"cartlist", "Displays item list from cart"},
	{"itemlist", "Displays item list from inventory"},
	{"stats", "Displays current status and trait points"},
	{"delitem", "Deletes specific items from inventory"},
	{"charcommands", "Lists available # (char) commands"},
	{"font", "Changes the chat font"},
	{"accinfo", "Displays account information"},
	{"set", "Sets a variable for your character"},
	{"undisguiseguild", "Removes disguise from guild members"},
	{"disguiseguild", "Disguises all guild members"},
	{"sizeall", "Sets sprite size for all characters on map"},
	{"sizeguild", "Sets sprite size for guild members"},
	{"addperm", "Adds a permission to a player"},
	{"rmvperm", "Removes a permission from a player"},
	{"unloadnpcfile", "Unloads a specific NPC file"},
	{"cart", "Summons or removes your cart"},
	{"mount2", "Mounts secondary ride (e.g., dragon, gryphon)"},
	{"join", "Joins a chat room or public group"},
	{"channel", "Manages custom chat channels"},
	{"fontcolor", "Changes the color of your chat font"},
	{"langtype", "Sets your language preference"},
	{"vip", "Displays your VIP status or remaining time"},
	...
	{"changedress", "Changes dress style or uniform look"},
	{"camerainfo", "Toggles camera debug or status info"},
	{"resurrect", "Resurrects a dead player"},
	{"setquest", "Sets a specific quest as active"},
	{"erasequest", "Removes a quest from your log"},
	{"completequest", "Marks a quest as completed"},
	{"checkquest", "Checks quest progress or state"},
	{"refineui", "Opens the refine UI"},
	{"stylist", "Opens stylist interface for appearance customization"},
	{"addfame", "Adds fame points to a player"},
	{"enchantgradeui", "Opens enchant/grade UI"},
	{"roulette", "Triggers the gacha roulette interface"},
	{"setcard", "Inserts a card into an item manually"},
...
for (int j = 0; cmd_desc[j].name; j++) {
	if (strcmp(cmd->command, cmd_desc[j].name) == 0) {
		desc = cmd_desc[j].desc;
		break;
	}
}

if (desc)
	safesnprintf(line_buff, sizeof(line_buff), "@%s - %s", cmd->command, desc);
else
	safesnprintf(line_buff, sizeof(line_buff), "@%s", cmd->command);
